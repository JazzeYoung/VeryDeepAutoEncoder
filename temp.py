...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul 13 20:33:22 2016

@author: jazze
"""

"""This an implementation of Generative Contractive auto-encoders (GCA) using Theano.
...
def test_cA(learning_rate=0.01, training_epochs=20,
    ...
    print >> sys.stderr, ('The code for training ' + os.path.split(__file__)[1] +
...
###################################
    ...
    for i in range(10):
        ...
        newX = Image.fromarray(numpy.array(sample.get_value().reshape(28,28),
                                           dtype=numpy.uint8))
    ...
    image2 = Image.fromarray(ca.b.get_value(borrow=True).reshape(50,10))
